 ...
 * SGX_report(hash) \|\| custom_claims_buffer | | OE_FORMAT_UUID_SGX_ECDSA | [
 * oe_attestation_header ] \|\| SGX_ECDSA_p256_quote(hash) \|\|
 * custom_claims_buffer | | OE_FORMAT_UUID_SGX_EPID_LINKABLE | [
 ...
 * attestation) \|\| SGX_ECDSA_p256_quote(custom_claims_buffer) | |
 * OE_FORMAT_UUID_RAW_SGX_QUOTE_ECDSA |
 * SGX_ECDSA_p256_quote(custom_claims_buffer) |
 *
 * In the above table:
 ...
 * flat buffer of 64 bytes for its SGX report data field. Depending on the
 * format, this field holds either the hash of the custom claims, or the
