...
- TEE-agnostic claims IDs to be declared in `<openenclave/bits/evidence.h>`
...
- Verify evidence, optionally with a set of endorsements and policies.
  ...
  - The optional parameter `format_id` is added.
    ...
    generated by `oe_get_evidence()`. The header of of this type of evidence
...
for verification of SGX ECDSA reports generated by legacy API function
...
`OE_CLAIM_CUSTOM_CLAIMS_ID`. For SGX ECDSA reports and raw SGX ECDSA quotes,
